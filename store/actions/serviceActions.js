...
export const createService=(name,price,duration,barber_id,typeOfService)=>{
    ...
    return async () =>{
        ...
        try{
            const response= await fetch('http://95.111.243.233:3000/service/addService',{
                method : "POST",
                headers: {
...
export const updateService= (id,name,price,duration,typeOfService) => {
    ...
    return async () => {
         ...
         try{
           ...
           const response = await fetch(`http://95.111.243.233:3000/service/updateService/${id}`,{
              method:'PATCH',
              headers: {
                'Content-Type': 'application/json'
            },
...
export const deleteService = id => {
    ...
    return async () => {
        ...
        try{
            const response = await fetch(`http://95.111.243.233:3000/service/deleteService/${id}`,{
               method:'DELETE'});
